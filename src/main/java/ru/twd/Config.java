...
public class Config extends MidnightConfig {
    ...
    @Entry(category = REPAIRMENTS, name = "Limit [ % ]:", min = 1, max = 100, isSlider=true) public static int repair_limit = 25;

    @Entry(category = VANILLA, name = "Unlock Level:", min = 0) public static int passive_repair_level = 25;
    @Entry(category = VANILLA, name = "Amount Multiplier:", min = 0.0f) public static float passive_repair_amount_multiplier = 1.0f;
